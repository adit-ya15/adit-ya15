...
A frontend-focused dashboard application demonstrating role-based authentication, protected routes, and modern SaaS UI patterns.
- **Tech:** React, Context API, React Router, SCSS
- **Live:** https://insightdashh.netlify.app/
- **Code:** https://github.com/adit-ya15/InsightDash
